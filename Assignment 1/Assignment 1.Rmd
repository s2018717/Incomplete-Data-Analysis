...
```{r  stochastic regression imputation}
...
plot(density(Y2), lwd = 2, col = "blue", xlab = expression(Y[2]),
     main = "Stochastic Regression Imputation", ylim = c(0, 0.3))
lines(density(Y_sri), lwd = 2, col = "red")
legend(5, 0.3, legend = c("Complete data", "Completed (after imputation) data"),
